...
$('#datatable-ponto').DataTable({    
    ...
    "dom": 'lCfrtip',
    "serverSide": false,
    "ajax" : 'Alterar_Excluir_Ponto_C001_ajax.php',
    "columns": [
        { "searchable": true },
        null,
        null
...
//    var teste;
    ...
    if (Valores[0]>0) {    
        open('POST', 'Cadastro_Ponto_M001.php', {codigo:Valores[0],acao:'editar'}, '_self');
    }
    else{
...
$('#btnNovo').click(function(){
    ...
    open('POST', 'Cadastro_Ponto_M001.php', {codigo:0,acao:'novo'}, '_self');
});
...
$('#btnExcluir').click(function(){
    ...
    if (Valores[0]>0) {
        open('POST', 'Cadastro_Ponto_M001_ajax.php', {codigo:Valores[0],acao:'excluir'}, '_self');
    }
    else{
        alert('Nenhum Ponto Selecionado');con
    }
