                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <div class="x_content">
                                            <button type="button" <?php echo $_SESSION['tipo_acesso_button'] ?> id="btnNovo" name="btnNovo" class="btn btn-primary  fa fa-file-o "> Adicionar</button>

                                            <button type="button" id="btnEditar" name="btnEditar" class="btn btn-success  fa fa-edit "> Editar</button>

                                            <button type="button" <?php echo $_SESSION['tipo_acesso_button'] ?> id="btnExcluir" name="btnExcluir" class="btn btn-danger  fa fa-trash-o "> Excluir</button>
...
<!--    <script src="../vendors/datatables.net-responsive-bs/js/responsive.bootstrap.js"></script>-->
        ...
        <script src="Alterar_Excluir_Voluntarios_C001_ajax.js"></script>
