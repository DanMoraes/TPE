...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        <form class="form-horizontal form-label-left" id="formulario" action="Cadastro_Voluntario_Ponto_M001_ajax.php" method="post">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="Ponto-tab">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="x_title">
                                                        <h2>Ponto ( <?php echo  $ponto?> ) - <?php echo  $nome_ponto?> <small></small></h2>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <div class="x_content">
                                                        <br />
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Voluntário</label>
                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control" id="codigo_voluntario" name="codigo_voluntario">
                                                                    <option value=" "></option>
                                                                    
                                                                    <?php while( $jRow = $sth->fetch(PDO::FETCH_OBJ)){ ?>
                                                                   
                                                                    <option value="<?php echo  $jRow->codigo?>" id="voluntario"  <?php if ($seleciona == $jRow->codigo){echo "selected = 'true'";} ?>><?php echo  $jRow->nome?></option>
                                                                    <?php } ?>
<!--                                                                    <option value="B" id="circuito_b">SP-113</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-md-3 col-sm-3 col-xs-12 control-label">Está Designado</label>

                                                            <div class="col-md-9 col-sm-9 col-xs-12">                      
                                                                <div class="checkbox">
                                                                    <div class="form-group">
                                                                        <label><input value="A" type="checkbox" id="dia_semana_a" name="dia_semana_a"> Segunda</label>
                                                                        <label><input value="B" type="checkbox" id="dia_semana_b" name="dia_semana_b"> Terça</label>
                                                                        <label><input value="C" type="checkbox" id="dia_semana_c" name="dia_semana_c"> Quarta</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-12">                      
                                                                <div class="checkbox">
                                                                    <div class="form-group">
                                                                        <label><input value="D" type="checkbox" id="dia_semana_d" name="dia_semana_d"> Quinta</label>
                                                                        <label><input value="E" type="checkbox" id="dia_semana_e" name="dia_semana_e"> Sexta</label>
                                                                        <label><input value="F" type="checkbox" id="dia_semana_f" name="dia_semana_f"> Sábado</label>
                                                                        <label><input value="F" type="checkbox" id="dia_semana_g" name="dia_semana_g"> Domingo</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<!--        <script src="js/datepicker/daterangepicker.js"></script>-->
        ...
        <script src="Cadastro_Voluntario_Ponto_M001_ajax.js"></script>
