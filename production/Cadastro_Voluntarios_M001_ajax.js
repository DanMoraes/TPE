...
$(document).ready(function ()
{
    ...
    $.ajax({
        type: 'post',
        url: 'Cadastro_Voluntarios_M001_ajax.php',
        ...
        success: function (json) {
            ...
            $privilegio_4=data.privilegio.indexOf("B");
            if($privilegio_4>=0){ $("#privilegio_4").prop('checked', true);}   

            $privilegio_5=data.privilegio.indexOf("V");
            if($privilegio_5>=0){ $("#privilegio_5").prop('checked', true);}   
