...
switch ($acao) {
    ...
    case 'salvarNovo':
        ...
        if (isset($_POST['privilegio_4']))
            $privilegio_4 = $_POST['privilegio_4'];
        if (isset($_POST['privilegio_5']))
            $privilegio_5 = $_POST['privilegio_5'];
        ...
        $privilegio = $privilegio_1 . $privilegio_2 . $privilegio_3 . $privilegio_4 . $privilegio_5;
