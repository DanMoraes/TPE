                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <div class="x_content">
                                            <button type="button" id="btnFiltrar" name="btnFiltrar" class="btn btn-primary  fa fa-list-ul "> Filtrar</button>
...
<script src="Selecionar_Ponto_Designacao_C001_ajax.js"></script>
